...
<body >
  <div class="list-unstyled3" >
          <ul>
            <li><a href="vit.php"><img src="JSSATE.png" alt="JSSATEB"  class="logo2" height="40"  align="left"/></a></li>
             <!-- <li style="float:right"><a  href="logout.php">Log Out</a></li> -->
  
            <div class="para">
            <p> Training &amp; Placement,JSSATE</p>
                </div>  
                   </ul>
  ...
  <form method="post" action="student_register.php" enctype="multipart/form-data">
  	...
  	<div class="input-group">
  	  ...
  	  <input type="text" name="student_id" required pattern="^[1-4][a-z,A-Z]{2}[0-9]{2}[a-z,A-Z]{2}[0-9]{3}$" title="USN is invalid" value="<?php echo $student_id; ?>">
  	</div>
  	<div class="input-group">
